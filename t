...
int main()
{
    ...
    // Taking input for BST creation
    cout << "Enter the keys for BST separated by space: ";
    getline(cin, input);

    // Parsing input string and extracting values
    stringstream ss(input);
    int key;
    while (ss >> key) {
    ...
    cout << "Modified BST tree after deleting Node: " << endl;
    inorder(root);
    cout << endl;
